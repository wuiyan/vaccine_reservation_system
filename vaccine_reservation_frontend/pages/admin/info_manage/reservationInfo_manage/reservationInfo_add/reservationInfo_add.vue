<template>
  <view class="flex-col justify-start page">
    <view class="flex-col group">
      <view class="flex-col justify-start items-center header"><text class="text">新增预约信息</text></view>
      <view class="flex-col group_1">
        ...
        <view class="flex-col mt-45">
          ...
          <view class="flex-col justify-start self-center text-wrapper_2 mt-57" @tap="submitReservationInfo">
            <text class="font_2 text_11">新增预约</text>
          </view>
      </view>
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    submitReservationInfo(){
      ...
      request("reservations","POST",this.submitForm)
          .then(responseData => {
            if (responseData.code == 0) {
              ...
              uni.showModal({
                ...
                success: function (res) {
                  if (res.confirm) {
                    ...
                    uni.navigateBack({
                      url: "/pages/admin/info_manage/reservationInfo_manage/reservationInfo_manage",
                      success: () => {
              ...
              this.showToast("新增预约信息失败："+responseData.message)
            }
          }).catch(error => {
